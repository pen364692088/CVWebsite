...
export function ArtifactsSection({ copy, artifacts, activeLens, activeLensTitle, onArtifactOpen }: ArtifactsSectionProps) {
  ...
  return (
    <section id="artifacts" className="section-shell archive-chamber-section">
      <Reveal>
      ...
      <div className="artifact-gallery-frame">
                ...
                >
                  ...
                  <div className="artifact-plaque">
                    <div className="space-y-3">
                      <h3 className="font-display text-3xl text-ivory">{artifact.displayTitle}</h3>
                      <p className="artifact-role">{artifact.displaySubtitle}</p>
                      <p className="text-sm leading-7 text-mist">{artifact.displayBody}</p>
                    </div>
            ...
            <aside className="artifact-annex" aria-live="polite">
              <div className="space-y-3">
                ...
                <h3 className="font-display text-3xl text-ivory">
                  {activeLens === "all" ? copy.shelfTitle : leadArtifact.displayTitle}
                </h3>
